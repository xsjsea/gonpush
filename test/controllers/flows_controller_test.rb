...
class FlowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flow" do
    assert_difference('Flow.count') do
      post flows_url, params: { flow: { flow_name: @flow.flow_name, flow_order: @flow.flow_order, flow_type: @flow.flow_type } }
    end
  ...
  test "should update flow" do
    patch flow_url(@flow), params: { flow: { flow_name: @flow.flow_name, flow_order: @flow.flow_order, flow_type: @flow.flow_type } }
