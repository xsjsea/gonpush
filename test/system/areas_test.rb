...
class AreasTest < ApplicationSystemTestCase
  ...
  test "creating a Area" do
    ...
    fill_in "Areaname", with: @area.areaName
    fill_in "Area Level", with: @area.area_level
    fill_in "Area Sequence", with: @area.area_sequence
    fill_in "Parent", with: @area.parent_id
